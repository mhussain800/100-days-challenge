          ...
          return (
            <section key={category} className="task-group">
              ...
              <div className="task-list">
                {categoryTasks.map((task) => <TaskRow key={task.id} task={task} value={currentLog[task.id] || {}} isPast={isPastDate} onChange={(field, value) => updateTask(task.id, field, value)} />)}
  ...
  return (
    <div className="page-stack">
      ...
      <div className="today-card-layout">
        {todayCardOrder.map((cardId) => <div key={cardId} className={cardId === 'habits' || cardId === 'study' ? 'today-card-full' : 'today-card-half'}>{todayCards[cardId]}</div>)}
      </div>
